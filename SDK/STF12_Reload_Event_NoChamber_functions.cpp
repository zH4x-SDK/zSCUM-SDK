...
float USTF12_Reload_Event_NoChamber_C::ExecuteUsingData(const struct FWeaponReloadData& Data)
{
...
bool USTF12_Reload_Event_NoChamber_C::CanExecuteUsingData(const struct FWeaponReloadData& Data)
{
