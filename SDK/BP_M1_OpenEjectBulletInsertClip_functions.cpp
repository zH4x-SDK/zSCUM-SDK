...
float UBP_M1_OpenEjectBulletInsertClip_C::ExecuteUsingData(const struct FWeaponReloadData& Data)
{
...
bool UBP_M1_OpenEjectBulletInsertClip_C::CanExecuteUsingData(const struct FWeaponReloadData& Data)
{
