...
float UBP_M1_OpenEjectBulletInsertClipInsertBulletLoop_C::ExecuteUsingData(const struct FWeaponReloadData& Data)
{
...
bool UBP_M1_OpenEjectBulletInsertClipInsertBulletLoop_C::CanExecuteUsingData(const struct FWeaponReloadData& Data)
{
