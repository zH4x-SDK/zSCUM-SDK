...
float UM1887_InsertShell_C::ExecuteUsingData(const struct FWeaponReloadData& Data)
{
...
bool UM1887_InsertShell_C::CanExecuteUsingData(const struct FWeaponReloadData& Data)
{
